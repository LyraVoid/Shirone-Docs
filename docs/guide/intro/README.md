...
<CardGrid>
  <Card title="动态配色" icon="ri:palette-line">
    基于 ==HCT 色彩空间== 与 Material Color Utilities 的动态配色系统，支持从横幅壁纸实时提取主题色，内置 ==8 大调色板与 25 种以上颜色角色==。
  </Card>
